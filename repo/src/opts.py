...
def parse_opt():
    ...
    parser.add_argument('--search_dataset', default="search18", help='used search dataset')
    parser.add_argument('--use_responses', action="store_true", help='use VLM responses for train')
    parser.add_argument('--unseen', action="store_true", help='test for unseen objects')
    parser.add_argument('--vlm_based', action="store_true", help='use VLM for generate scanpaths')
