...
TORCH_DISTRIBUTED_DEBUG=DETAIL accelerate launch --config_file repo/src/config.yaml --main_process_port 29600 repo/src/train_explanation_alignment.py --project_dir runs/${MODEL_NAME} \
  --project_name ExplanationScanpath --checkpoint_every 1 --checkpoint_every_rl 1 --epochs 10 --start_rl_epoch 8  --batch 32 --test_batch 48 --dataset_dir "$1/$2/" \
   --search_dataset $3 --explanation --unseen
